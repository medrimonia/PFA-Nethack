...
cela est nécessaire\footnote{Par exemple les bots écris en Java.}. Lorsque la
...
\verb!Makefile!. Dans chacun de ces dossiers\footnote{Chaque dossier
correspond à un bot particulier.} est exécutée la commande \verb!make! afin de
compiler les sources du bot en question.
...
la variable d'environnement \verb!NH_MM_DUPMSGS!), un fichier nethackdir/replay
...
\paragraph{} Le fichier nethackdir/replay peut également être utilisé dans d'autres buts.

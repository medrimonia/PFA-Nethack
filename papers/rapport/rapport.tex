...
% -----------------------------------------------------------------------
% -----------------------------------------------------------------------
% A mon avis ce qui suit n'est pas utile. Ca a sa place dans le manuel
% -----------------------------------------------------------------------
% -----------------------------------------------------------------------
...
deux patchs et donc les modifications qu'un seul d'entre eux apporte doit être
minimal. Ce découpage en petits patchs permet de pouvoir les réutiliser d'un
...
nombre de manipulations à effectuer. Ce type de graphes étant utilisé pour

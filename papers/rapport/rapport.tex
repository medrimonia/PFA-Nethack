...
perl {\verb|toTikz.pl|}.%TODO ok Benoît?
...
NetHack\footnote{url{http://nethack.wikia.com/wiki/Dungeon.def\_format}}. Il
est donc possible de désactiver les niveaux spéciaux en modifiant ce fichier.
Cependant NetHack ayant des comportements parfois asbcons, nous ne pouvons
garantir le fonctionnement du jeu sans niveau spéciaux.
...
d'éviter recalculer le maximum à chaque fois et d'insérer les cases dans un

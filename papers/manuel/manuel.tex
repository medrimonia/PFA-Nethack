...
\section{Générer la carte du nombre de visites de chaque case des niveaux}

Le fichier \emph{nethackdir/replay} peut également être interprété par le
programme \emph{viewer/toTikZ.pl} qui génère une carte donnant un apperçu du

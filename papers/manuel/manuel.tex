...
En mettant la variable d'environnement \verb!NH_MM_REPLAY! à une valeur
...
$ NH_MM_REPLAY=1 ./nethack-3.4.3/nethack 2> /dev/null 1| perl dummy-client.pl
...
\begin{verbatim}
$ NH_MM_REPLAY=1 ./nethack-3.4.3/nethack 1> replay
